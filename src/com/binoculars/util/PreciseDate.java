...
public class PreciseDate implements Comparable<PreciseDate> {
    private final long utcNanos;

    public PreciseDate(long utcNanos) {
        this.utcNanos = utcNanos;
    }

    public PreciseDate add(PreciseClock.TimeSpan span) {
        return new PreciseDate(utcNanos + span.toNanos());
    }

    public int compareTo(PreciseDate o) {

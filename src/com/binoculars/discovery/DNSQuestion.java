...
public class DNSQuestion extends DNSEntry {
    ...
    private static class DNS4Address extends DNSQuestion {
        ...
        @Override
        public void addAnswers(ZeroConf jmDNSImpl, Set<DNSRecord> answers) {
        ...
        @Override
        public boolean iAmTheOnlyOne(ZeroConf jmDNSImpl) {
        ...
        public void addAnswers(ZeroConf jmDNSImpl, Set<DNSRecord> answers) {
            ...
            if (this.isServicesDiscoveryMetaQuery()) {
                for (String serviceType : jmDNSImpl.getServiceTypes().keySet()) {
                    ZeroConf.ServiceTypeEntry typeEntry = jmDNSImpl.getServiceTypes().get(serviceType);
                ...
                String ipValue = this.getQualifiedNameMap().get(ServiceInfo.Fields.Instance);
    ...
    protected void addAnswersForServiceInfo(ZeroConf jmDNSImpl, Set<DNSRecord> answers, ServiceInfoImpl info) {
    ...
    /*
     * (non-Javadoc)
     * @see DNSEntry#toString(java.lang.StringBuilder)
     */
    @Override

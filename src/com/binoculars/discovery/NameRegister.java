...
public interface NameRegister {
    ...
    class UniqueNamePerInterface implements NameRegister {

        /*
         * (non-Javadoc)
         * @see NameRegister#register(java.net.InetAddress, java.lang.String, NameRegister.NameType)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see NameRegister#checkName(java.net.InetAddress, java.lang.String, NameRegister.NameType)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see NameRegister#incrementHostName(java.net.InetAddress, java.lang.String, NameRegister.NameType)
         */
        @Override
    ...
    class UniqueNameAcrossInterface implements NameRegister {

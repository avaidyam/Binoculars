...
public class NetworkTopologyEventImpl extends NetworkTopologyEvent implements Cloneable {
     ...
     *                if source is null.
     */
    public NetworkTopologyEventImpl(ZeroConf zeroConf, InetAddress inetAddress) {
        super(zeroConf);
    ...
    /*
     * (non-Javadoc)
     * @see NetworkTopologyEvent#getDNS()
     */
    @Override
    public ZeroConf getDNS() {
        return (this.getSource() instanceof ZeroConf ? (ZeroConf) getSource() : null);
    }

    /*
     * (non-Javadoc)
     * @see NetworkTopologyEvent#getInetAddress()
     */
    @Override

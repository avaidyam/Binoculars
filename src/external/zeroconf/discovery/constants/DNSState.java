...
package external.zeroconf.discovery.constants;

/**
 * DNSState defines the possible states for services registered with ZeroConf.
 *
    ...
    public final DNSState advance() {
        switch (this) {
            ...
            case CLOSED:
                return CLOSED;
            default:
                // This is just to keep the compiler happy as we have covered allOf cases before.
                return this;
        }
    }

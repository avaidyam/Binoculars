...
public class HostInfo implements DNSStatefulObject {
    ...
    private final static class HostInfoState extends DNSStatefulObject.DefaultImplementation {
         ...
         * @param dns
         */
        public HostInfoState(ZeroConf dns) {
            super();
            this.setDns(dns);
        }
     ...
     * @return new HostInfo
     */
    public static HostInfo newHostInfo(InetAddress address, ZeroConf dns, String jmdnsName) {
    ...
    private HostInfo(final InetAddress address, final String name, final ZeroConf dns) {
        super();

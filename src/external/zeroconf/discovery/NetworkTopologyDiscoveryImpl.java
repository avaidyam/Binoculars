...
public class NetworkTopologyDiscoveryImpl implements NetworkTopologyDiscovery {
    ...
    /*
     * (non-Javadoc)
     * @see JmmDNS.NetworkTopologyDiscovery#getInetAddresses()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see JmmDNS.NetworkTopologyDiscovery#useInetAddress(java.net.NetworkInterface, java.net.InetAddress)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see NetworkTopologyDiscovery#lockInetAddress(java.net.InetAddress)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see NetworkTopologyDiscovery#unlockInetAddress(java.net.InetAddress)
     */
    @Override

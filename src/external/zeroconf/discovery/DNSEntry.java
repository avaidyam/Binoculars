...
public abstract class DNSEntry {
    ...
    DNSEntry(String name, DNSRecordType type, DNSRecordClass recordClass, boolean unique) {
        ...
        String domain = _qualifiedNameMap.get(ServiceInfo.Fields.Domain);
        String protocol = _qualifiedNameMap.get(ServiceInfo.Fields.Protocol);
        String application = _qualifiedNameMap.get(ServiceInfo.Fields.Application);
        String instance = _qualifiedNameMap.get(ServiceInfo.Fields.Instance).toLowerCase();
    ...
    public String getSubtype() {
        String subtype = this.getQualifiedNameMap().get(ServiceInfo.Fields.Subtype);
    ...
    public boolean isServicesDiscoveryMetaQuery() {
        return _qualifiedNameMap.get(ServiceInfo.Fields.Application).equals("dns-sd") && _qualifiedNameMap.get(ServiceInfo.Fields.Instance).equals("_services");
    }
    ...
    public boolean isDomainDiscoveryQuery() {
        ...
        if (_qualifiedNameMap.get(ServiceInfo.Fields.Application).equals("dns-sd")) {
            String name = _qualifiedNameMap.get(ServiceInfo.Fields.Instance);
    ...
    public boolean isV4ReverseLookup() {
        return _qualifiedNameMap.get(ServiceInfo.Fields.Domain).endsWith("in-addr.arpa");
    }

    public boolean isV6ReverseLookup() {
        return _qualifiedNameMap.get(ServiceInfo.Fields.Domain).endsWith("ip6.arpa");
    }

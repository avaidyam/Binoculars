...
public abstract class DNSRecord extends DNSEntry {
    ...
    /*
     * (non-Javadoc)
     * @see DNSEntry#equals(java.lang.Object)
     */
    @Override
     ...
     */
    public abstract boolean sameValue(DNSRecord other);
     ...
     *
     * @return Returns true if a conflict with one of the services registered with ZeroConf or with the hostname occured.
     */
    public abstract boolean handleQuery(ZeroConf dns, long expirationTime);
     ...
     * @return Returns true if a conflict with one of the services registered with ZeroConf or with the hostname occured.
     */
    public abstract boolean handleResponse(ZeroConf dns);

    /**
     * Adds this as an answer to the provided outgoing datagram.
     */
    public abstract DNSOutgoing addAnswer(ZeroConf dns, DNSIncoming in, InetAddress addr, int port, DNSOutgoing out) throws IOException;
     ...
     */
    public abstract void write(DNSOutgoing.MessageOutputStream out);
    ...
    public static class IPv4Address extends Address {
        ...
        /*
         * (non-Javadoc)
         * @see DNSRecord#getServiceInfo(boolean)
         */
        @Override
    ...
    public static abstract class Address extends DNSRecord {
         ...
         */
        @Override
        public boolean handleQuery(ZeroConf dns, long expirationTime) {
         ...
         */
        @Override
        public boolean handleResponse(ZeroConf dns) {
            if (dns.getLocalHost().conflictWithRecord(this)) {
        ...
        @Override
        public DNSOutgoing addAnswer(ZeroConf dns, DNSIncoming in, InetAddress addr, int port, DNSOutgoing out) throws IOException {
            return out;
        }
        ...
        /*
         * (non-Javadoc)
         * @see DNSRecord#getServiceEvent(ZeroConfImpl)
         */
        @Override
        public ServiceEvent getServiceEvent(ZeroConf dns) {
    ...
    public static class Pointer extends DNSRecord {
        ...
        /*
         * (non-Javadoc)
         * @see DNSEntry#isSameEntry(DNSEntry)
         */
        @Override
        ...
        public ServiceEvent getServiceEvent(ZeroConf dns) {
            ...
            String serviceName = ZeroConf.toUnqualifiedName(domainName, this.getAlias());
    ...
    public static class HostInformation extends DNSRecord {
        ...
        /*
         * (non-Javadoc)
         * @see DNSRecord#addAnswer(ZeroConfImpl, DNSIncoming, java.net.InetAddress, int, DNSOutgoing)
         */
        @Override
        public DNSOutgoing addAnswer(ZeroConf dns, DNSIncoming in, InetAddress addr, int port, DNSOutgoing out) throws IOException {
            return out;
        ...
        /*
         * (non-Javadoc)
         * @see DNSRecord#handleQuery(ZeroConfImpl, long)
         */
        @Override
        public boolean handleQuery(ZeroConf dns, long expirationTime) {
            return false;
        ...
        /*
         * (non-Javadoc)
         * @see DNSRecord#handleResponse(ZeroConfImpl)
         */
        @Override
        public boolean handleResponse(ZeroConf dns) {
            return false;
        ...
        /*
         * (non-Javadoc)
         * @see DNSRecord#sameValue(DNSRecord)
         */
        @Override
        public boolean sameValue(DNSRecord other) {
        ...
        /*
         * (non-Javadoc)
         * @see DNSRecord#write(DNSOutgoing)
         */
        @Override
        public void write(DNSOutgoing.MessageOutputStream out) {
     ...
     */
    public abstract ServiceEvent getServiceEvent(ZeroConf dns);

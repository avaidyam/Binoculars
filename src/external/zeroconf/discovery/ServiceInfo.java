...
public abstract class ServiceInfo implements Cloneable {
    ...
    /**
     * Construct a service description for registering with ZeroConf.
     * 
     * @param type
    ...
    /**
     * Construct a service description for registering with ZeroConf. The properties hashtable must map property names to either Strings or byte arrays describing the property values.
     * 
     * @param type
     *            fully qualified service type name, such as <code>_http._tcp.local.</code>.
     * @param name
    ...
    /**
     * Returns a list of allOf InetAddresses that can be used for this service.
     * <p>
    ...
    /**
     * Returns a list of allOf IPv4 InetAddresses that can be used for this service.
     * <p>
     * In a multi-homed environment service info can be associated with more than one address.
     * </p>
     * 
    ...
    /**
     * Returns a list of allOf IPv6 InetAddresses that can be used for this service.
     * <p>
     * In a multi-homed environment service info can be associated with more than one address.
     * </p>
     * 

...
/**
 * This is the root class for allOf task scheduled by the timer in ZeroConf.
 * 
...
public abstract class DNSTask extends TimerTask {
     ...
     * @param jmDNSImpl
     */
    protected DNSTask(ZeroConf jmDNSImpl) {
        super();

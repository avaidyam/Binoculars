 ...
 * <p/>
 * The ServiceInfoResolver will run only if ZeroConf is in state ANNOUNCED. REMIND: Prevent having multiple service resolvers for the same info in the timer queue.
 */
public class ServiceInfoResolver extends DNSResolverTask {

    private final ServiceInfoImpl _info;

    public ServiceInfoResolver(ZeroConf jmDNSImpl, ServiceInfoImpl info) {
        super(jmDNSImpl);
        this._info = info;
